...
# Trackpad: set fastest tracking speed
...
# 13: Lock Screen
# Top left screen corner + Option → Mission Control
defaults write com.apple.dock wvous-tl-corner -int 2
defaults write com.apple.dock wvous-tl-modifier -int 524288
# Top right screen corner → Quick Note
defaults write com.apple.dock wvous-tr-corner -int 14
defaults write com.apple.dock wvous-tr-modifier -int 0
# Bottom left screen corner + Option → Put display to sleep
